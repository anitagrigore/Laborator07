...
public class CalculatorWebServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        if (operator1 == null || operator1.isEmpty()) {
            errorMsg = Constants.ERROR_MESSAGE_EMPTY;
        }
        ...
        switch (method) {
            ...
            case Constants.POST_OPERATION:
                ...
                attributes.add(new BasicNameValuePair(Constants.OPERATION_ATTRIBUTE, operation));
                attributes.add(new BasicNameValuePair(Constants.OPERATOR1_ATTRIBUTE, operator1));
                attributes.add(new BasicNameValuePair(Constants.OPERATOR2_ATTRIBUTE,operator2));

                try {
                    UrlEncodedFormEntity urlEncodedFormEntity = new UrlEncodedFormEntity(attributes, HTTP.UTF_8);
